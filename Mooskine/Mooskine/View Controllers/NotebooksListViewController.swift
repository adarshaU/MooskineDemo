...
class NotebooksListViewController: UIViewController, UITableViewDataSource,NSFetchedResultsControllerDelegate {
    ...
    //var dataSource:ListDataSource<Notebook, NotebookCell,Notebook>?
...
//        tableView.dataSource = ListDataSource(tableView: tableView, managedObjectContext: dataController.viewContext, fetchRequest: fetchRequest, configure: { (cell, note) in
//
//            print(note)
//
//
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let vc = segue.destination as? NotesListViewController {
            if let indexPath = tableView.indexPathForSelectedRow {
                ...
                vc.dataControler = dataController
            }
        }
    }
}
